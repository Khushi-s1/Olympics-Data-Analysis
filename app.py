...
if user_menu == 'Overall Analysis':
    ...
    athlete_over_time = helper.data_over_time(df, 'Event')
    st.title("Events over the Year")
    fig = px.line(athlete_over_time, x="Edition", y="Event")
    st.plotly_chart(fig)
...
if user_menu == 'Athlete wise Analysis':
    ...
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics', 'Swimming', 'Badminton', 'Sailing',
                     'Gymnastics', 'Art Competitions', 'Handball', 'Rowing', 'Fencing', 'Shooting', 'Boxing',
